...
const CHOICES_KEYS_SPECIALS = [
	...
	{ label: 'Numpad / divide (No Linux)', id: 'keypaddivide' },
	{ label: 'Numpad * multiply (No Linux)', id: 'keypadmultiply' },
	{ label: 'Numpad - minus (No Linux)', id: 'keypadminus' },
	{ label: 'Numpad + plus (No Linux)', id: 'keypadplus' },
	{ label: 'Numpad . decimal (No Linux)', id: 'keypaddecimal' },
	{ label: 'Numpad separator (Windows only)', id: 'keypadseparator' },
